...
class YOLO(object):
    def __init__(self):
        ...
        self.model_path = os.path.join('./algoModule/estimateAgeGender/model/ep062-loss28.215-val_loss28.491.h5')  # 模型文件
        self.classes_path = os.path.join('./algoModule/estimateAgeGender/configs/wider_classes.txt')  # 类别文件
        self.score = 0.50  # 0.6
        self.iou = 0.45
        # self.iou = 0.01
